<template>
  <div>
    <MonevSuccessPage
      ...
      :ticket-no="store.submitResult?.ticket_no"
      @reset="handleReset"
    />
    <div
      v-else
      class="min-h-screen bg-[var(--color-background)] flex items-start justify-center px-4 py-8"
    >
      <div class="w-full max-w-3xl">
        <!-- ── Header Card ── -->
        <div class="card mb-6 overflow-hidden p-0">
          <div
            class="bg-gradient-to-r from-primary-700 to-primary px-6 py-5 flex items-center gap-4"
          >
...
import MonevSuccessPage from './MonevSuccessPage.vue'
